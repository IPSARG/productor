...
<ul class="list-unstyled components">
    ...
    <li class="{{ Route::is( 'categorias_aplicativos.update','aplicativos','aplicativos.delete','aplicativos.updatev','aplicativos.update','aplicativos.save') ? 'active' : '' }}">
        <a href="{{ url('aplicativos') }}"><i class="fas fa-dot-circle pr-2 text-light"></i> Aplicativos</a>
    </li>
</ul>
